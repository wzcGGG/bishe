...
def scheduleCreator(social):
    ...
    numAgent = 6000
    modTime = 24
    randomizedAgents = list(itertools.repeat("S",3000))
    randomizedAgents.extend(list(itertools.repeat("H",1500)))
    randomizedAgents.extend(list(itertools.repeat("A",1500)))
    OnorOff = list(itertools.repeat("On",4500))
    OnorOff.extend(list(itertools.repeat("Off",1500)))
    ...
    num_STEM_buildings = [6,6,9] #number of [small,medium,large] buildings
    num_Arts_buildings = [6,3,3]
    num_Hum_buildings = [3,6,3]
